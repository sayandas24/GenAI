...
export default function AvatarList() {
  ...
  // Fully type-safe — avatarId is `string | undefined` per the Zod schema
          ...
          >
            ...
            <div className="flex-1 min-w-0 flex flex-col justify-center gap-1">
              <div className="flex justify-between items-center">
                <span className="font-medium text-[15px] whitespace-nowrap overflow-hidden text-ellipsis text-white">
                  {avatar.name}
                </span>
